...
CRED_RE="$CRED_RE"'|xox[baprs]-[A-Za-z0-9-]{10,}'
CRED_RE="$CRED_RE"'|(password|passwd|secret|api[_-]?key|access[_-]?token|client[_-]?secret)["'"'"' ]*[:=]["'"'"' ]*[A-Za-z0-9/+._-]{12,}'
